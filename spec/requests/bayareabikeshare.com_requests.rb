uri = "http://bayareabikeshare.com/stations/json"

json_response = '{
   "executionTime":"2013-10-08 02:10:01 PM",
   "stationBeanList":[
      {
         "id":2,
      ...
      {
         "id":24,
         "stationName":"Redwood City Public Lilbrary",
         "availableDocks":4,
         "totalDocks":15,
         "latitude":37.484022,
         "longitude":-122.227671,
         "statusValue":"In Service",
         "statusKey":1,
         "availableBikes":11,
         "stAddress1":"Redwood City Public Lilbrary",
...
FakeWeb.register_uri(:get, uri, :body => json_response)